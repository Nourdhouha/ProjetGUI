-- =====================================================
-- Update Flight Data to Tunisia Origins (2026)
-- =====================================================
-- Execute this script to update existing flights with Tunisian origins

USE voyage_affaires;

-- First, delete old flights
DELETE FROM vol WHERE id_vol IN ('AF001', 'AF002', 'LH003', 'BA004', 'AF005');

-- Insert new Tunisian flights
...
-- Update hotels to add more international destinations
-- Delete old hotels that might conflict
DELETE FROM hotel WHERE id_hotel IN ('H004', 'H005');

-- Insert new hotels (H004-H008)
...
-- Add new hotels only if they don't exist
...
-- Verify the updates
SELECT '=== FLIGHTS FROM TUNISIA ===' AS '';
SELECT id_vol, compagnie, origine, destination, date_depart, date_arrivee, prix 
FROM vol 
ORDER BY date_depart;

SELECT '=== AVAILABLE HOTELS ===' AS '';
